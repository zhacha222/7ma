...
<img width="1912" height="909" alt="2524f4fc032da1140db6af489f423fc2" src="https://github.com/zhacha222/7ma/blob/main/docs/c07dffb8af7a0c131aff023f9948d32b.png" />
## ⚠️ 免责申明（Disclaimer）
...
- **管理后台**（`/admin`，默认密码 `password`）：
  ...
  - 积分获取：查看各账号当前积分，支持运行 / 定时运行（可批量）/ 自动兑换骑行卡（188 积分/张）/ 查看日志。
...
- **远程 API**：通过 `X-API-Key` 鉴权，提供下单与状态查询接口,可对接移动端app。
...
1. 到 [GitHub Releases](https://github.com/zhacha222/7ma/releases) 下载 `7MA_v2.0.0.exe`。
